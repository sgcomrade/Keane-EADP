<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="SubPlanB.aspx.cs" Inherits="EADP_Proj.SubPlanB" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">Subscription Plan B</h3>
                    </div>
        </div>
        <br />
        <br />
